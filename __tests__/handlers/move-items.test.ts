...
import { beforeEach, describe, expect, it, type Mock, vi } from 'vitest' // Removed unused afterEach
...
describe('handleMoveItems Core Logic Tests', () => {
	...
	it('should reject requests with empty operations array (Zod validation)', async () => {
		...
		await expect(handleMoveItemsFuncCore(args, mockDependencies)).rejects.toThrow(/Operations array cannot be empty/)
	})
